  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Legal Notice</h1>
          ...
          <div className="space-y-6 text-gray-600">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">Commercial Register</h2>

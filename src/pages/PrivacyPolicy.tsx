      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          ...
          <div className="space-y-6 text-gray-600">
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">1. Privacy at a Glance</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Data Collection on Our Website</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">3. Your Rights</h2>
